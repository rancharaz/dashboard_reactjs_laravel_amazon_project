...
const ConfirmBox = ({productId, open, closeDialogue }) => {
    ...
    return (
        <div open={open}       onClose={closeDialogue}>
                ...
                <div class="relative px-4 min-h-screen md:flex md:items-center md:justify-center">
                    ...
                    <div class="bg-white rounded-lg md:max-w-md md:mx-auto p-4 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative shadow-lg">
                        ...
                        <div class="text-center md:text-right mt-4 md:flex md:justify-end">
                            <button onClick={()=> deleteAction(productId)}  id="confirm-delete-btn" class="block w-full md:inline-block md:w-auto px-4 py-3 md:py-2 bg-red-200 text-red-700 rounded-lg font-semibold text-sm md:ml-2 md:order-2">
                                Delete
                            </button>
                            <button onClick={closeDialogue} id="confirm-cancel-btn" class="block w-full md:inline-block md:w-auto px-4 py-3 md:py-2 bg-gray-200 rounded-lg font-semibold text-sm mt-4 md:mt-0 md:order-1">
                                Cancel
                            </button>
                        </div>
                    </div>
